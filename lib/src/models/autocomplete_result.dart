...
List<AutoCompleteResultModel> autoCompleteResultModelFromJson(String str) =>
    List<AutoCompleteResultModel>.from(
        json.decode(str).map((x) => AutoCompleteResultModel.fromJson(x)));

String autoCompleteResultModelToJson(List<AutoCompleteResultModel> data) =>
